...
const PLAYLIST = [
  new PlaylistItem(
    'Comfort Fit - Rock',
    'http://p.scdn.co/mp3-preview/229bb6a4c7011158cc7e1aff11957e274dc05e84?cid=162b7dc01f3a4a2ca32ed3cec83d1e02',
    false
  ),
    new PlaylistItem(
        'JL - “House”',
        'https://www.bensound.com/royalty-free-music?download=house',
        false
    ),
  new PlaylistItem(
    'Big Buck Bunny',
  ...
  new PlaylistItem(
    'The Whole Other – “The Basemant Strut”',
    'https://www.youtube.com/audiolibrary_download?vid=59ed6458cf1d121b',
    false
  ),
  new PlaylistItem(
    "Diamond Ortiz - A to the O",
    'https://www.youtube.com/audiolibrary_download?vid=cbee85b69d32622a',
    false
  ),
  new PlaylistItem(
